...
```{r}
plot_den <- d_FR_MATDE / (d_DS_ARBOL + labs(y="Abundance")) / d_HIDRO_ITH / plot_spacer() 

plot_div <- di_FR_MATDE / (di_DS_ARBOL + labs(y="Diversity")) / di_HIDRO_ITH / di_TP_ES_OE 

plot_rich <- r_FR_MATDE / r_HIDRO_ITH / r_elev / (r_TP_ES_OE + labs(y="Richness")) / r_TP_EXPO / r_TP_RSD_P / r_TP_RSH_V 
...
```{r}
plot_rich_a <- r_FR_MATDE / (r_HIDRO_ITH + labs(y="Richness")) / r_elev / r_TP_ES_OE 
  
plot_rich_b <- r_TP_EXPO / r_TP_RSD_P / r_TP_RSH_V / plot_spacer() 
